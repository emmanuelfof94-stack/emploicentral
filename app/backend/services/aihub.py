...
class AIHubService:
    ...
    def __init__(self):
        ...
        # getattr avec défaut : en prod ces variables peuvent être absentes, et
        # Settings.__getattr__ lève AttributeError pour une variable d'env manquante.
        base_url = getattr(settings, "app_ai_base_url", "") or ""
        api_key = getattr(settings, "app_ai_key", "") or ""
